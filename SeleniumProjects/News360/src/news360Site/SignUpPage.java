...
public class SignUpPage {
	...
	By signUpConfirmPasswordTextBox = By.xpath(
			"//form[@class='signup ng-pristine ng-valid'][1]//fieldset//input[@class='confirmpassword textbox']");
	By signUpButton = By.xpath("//button[text()='Sign up']");
	By signUpLink = By.xpath("//a[text()='Sign up']");
	public By requiredEmailText = By.xpath("(//li[text()='This value is required.'])[1]");
	public By requiredPasswordText = By.xpath("(//li[text()='This value is required.'])[2]");
	public By requiredConfirmPasswordText = By.xpath("(//li[text()='This value is required.'])[3]");
	public By passwordTooShort = By.xpath("//li[@class='minlength']");
	public By errorMessage = By.xpath("//div[text()='Invalid login or password']");
	By shouldBeTheSameText = By.xpath("//li[text()='This value should be the same.']");
	...
	public WebElement getRequiredValue(String occurance) throws Exception {
		By requiredValue = By.xpath("(//li[text()='This value is required.'])" + "[" + occurance + "]");
		return driver.findElement(requiredValue);
	}

	public WebElement getShouldBeTheSameText() throws Exception {
		return driver.findElement(shouldBeTheSameText);
	}
}
