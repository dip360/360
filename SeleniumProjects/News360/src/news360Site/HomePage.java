...
public class HomePage {
	...
	By signInWithEmail = By.xpath(("(//a[text()='Sign in with email'])[1]"));
	...
	By signUpLink = By.xpath("//span[@ng-bind='::localization.landing_forgot_password']/following-sibling::*");
	...
	private WebElement getSignInWithEmailLink() {
		...
		wf.waitForElement(driver, 10, signInWithEmail);
	...
	private WebElement getSignInEmailTextBox() {
		WebDriverFunctions wf = new WebDriverFunctions(driver);
		wf.waitForElement(driver, 10, signInEmailTextBox);
